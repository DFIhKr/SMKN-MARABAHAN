  ...
  const testimonials = [
    {
      ...
      image: "/eren.jpeg",
      quote:
        "Berkat pendidikan di SMKN 2 Marabahan, saya mendapatkan bekal keterampilan yang sangat relevan dengan kebutuhan industri IT. Saat ini saya sudah bekerja di perusahaan telekomunikasi terkemuka.",
    },
    {
      id: 2,
      ...
      image: "/levi.jpeg",
      quote:
        "Ilmu yang saya dapatkan di jurusan otomotif sangat bermanfaat untuk membangun usaha permodifan basikal saya. Para guru tidak hanya mengajarkan teknik balapan, tapi juga safeti raiding yang aplikatif.",
    },
    {
      id: 3,
      name: "Dvaren",
